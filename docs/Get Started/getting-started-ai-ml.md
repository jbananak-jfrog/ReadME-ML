...
next:
  pages:
    ...
    - slug: jfrog-ml-quickstart
      ...
      type: basic
---
JFrog ML solution acts as a centralized hub that proactively secures every AI workload — from third-party downloads {/*and Model Context Protocol (MCP) servers */} to custom in-house models — giving you the visibility needed to eliminate Shadow AI.
