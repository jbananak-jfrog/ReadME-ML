...
metadata:
  title: Feature Store Overview
  description: >-
    JFrog ML's Feature Store is a centralized service that facilitates the
    discoverability, reuse and accuracy of features.
  legacyUUIDs:
...
* **Training**: Keep a log of all features, and then retrieve them for training, at any point in time.
  ![](https://files.readme.io/3191aa9a6d43358c0cc5787e3b132616e49b3d97989883893276da4c0d996d13-uuid-a4086297-addb-f7cd-8da2-7eba66c0b28d.png)
