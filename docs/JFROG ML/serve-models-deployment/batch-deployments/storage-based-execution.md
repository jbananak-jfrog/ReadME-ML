---
title: Storage-based Execution
excerpt: >-
  The low-level API of the batch execution allows you to start an execution from
  a specific remote path, and write the results to another path.
deprecated: false
hidden: false
metadata:
  robots: index
