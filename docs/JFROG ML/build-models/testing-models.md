...
[Adding Integration Tests to a Model Build](#adding-integration-tests-to-a-model-build)
...
<Callout icon="📘" theme="info">
  **Note**
  ...
  For testing, we require the frogml package (the SDK). The CLI includes the SDK so make sure to install the <Anchor label="**frogml-cli**" title="Get Started with JFrog ML" href="/docs/get-started-with-jfrog-ml">**frogml-cli**</Anchor> or just `frogml` in your local environment.
</Callout>
