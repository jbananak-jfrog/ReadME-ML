...
metadata:
  title: JFrog ML Architecture
  description: Explore the architecture that makes JFrog ML a single, trusted platform for MLOps.
  robots: index
  legacyUUIDs:
    - UUID-50703231-b3fc-579c-e523-eb5343b3e6df
    - UUID-fc07ad7d-464d-f2b8-86de-ea25304abbf8
---
Explore the architecture that makes JFrog ML a single, trusted platform for MLOps.
...
See [Control and Data Planes Interaction](/docs/control-and-data-planes-interaction "Control and Data Planes Interaction")
