...
metadata:
  title: JFrog AI Catalog
  description: Welcome to the JFrog AI Catalog – your centralized hub for AI model discovery, governance, and deployment. Here you can view and manage all AI models in your organization, including both those you are currently using, and those you want to use.
  robots: index
  legacyUUIDs:
    - UUID-589c01c9-0531-c0e1-ee99-a1795591eb45
    - UUID-1ad62589-2b99-9618-45a3-d0f8e8cc0823
...
![aicatalog-3tabs.png](image/uuid-4b05e20a-fe7a-0158-0a85-f7c89b95f7b8.png)

### AI Challenges

![Screenshot_2025-08-27_at_9_48_48.png](image/uuid-9a8e39b3-1253-d9ad-474d-655c2d7d5054.png)
...
* [JFrog AI Catalog Architecture](/docs/jfrog-ai-catalog-architecture "JFrog AI Catalog Architecture")
* [Getting Started](/docs/getting-started "Getting Started")
* [Discover and Allow Models](/docs/discover-and-allow-models "Discover and Allow Models")
* [Connect AI Providers](/docs/connect-ai-providers "Connect AI Providers")
