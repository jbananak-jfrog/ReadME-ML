...
metadata:
  title: Setting Up JFrog ML
  description: This page describes how to set up JFrog ML, including installing and configuring FrogML CLI and SDK.
  robots: index
  legacyUUIDs:
...
**Sub-option 2: Only if you already have the JF\_CLI installed and configured, use your username and password:**
...
*For any other issues with installing and configuring your FrogML SDK/CLI please refer to*  [Installation Issues](/docs/installation-issues "Installation Issues")  *or*  [Performance Issues](/docs/performance-issues "Performance Issues")  *pages.*
